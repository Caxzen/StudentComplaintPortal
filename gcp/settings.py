...
SECRET_KEY = 'django-insecure-9!*+25e=pdl*(&ss*r0cz-kde&d)$&ofz!6+)9+0vq)lgrrevs'
...
TEMPLATES = [
    {
        ...
        'DIRS': [r'C:\Users\ajay\Desktop\gc\authentication\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
